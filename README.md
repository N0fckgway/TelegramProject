# 🎂 КайфБот - Telegram Bot

**КайфБот** - это интеллектуальный Telegram бот для управления днями рождения друзей и близких. Бот автоматически напоминает о предстоящих праздниках и помогает не забывать важные даты.
